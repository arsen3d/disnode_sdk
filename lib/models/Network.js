...
const Network = module.exports = class Network {
  constructor(config) {
    ...
    //this.config = config || defaultConfig[process.env.NODE_ENV || (process.browser ? window.DisJS.ENV : 'production')];
      this.config = config || defaultConfig[process.env.mode] || defaultConfig["production"];
